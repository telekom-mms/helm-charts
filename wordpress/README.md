...
This helm chart installs WordPress.
...
# install
helm install telekom-mms/wordpress
```
...
```bash
helm upgrade --install wordpress wordpress --version 0.3.0 --repo https://telekom-mms.github.io/helm-charts/
```
